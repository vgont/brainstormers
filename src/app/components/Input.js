        ...
        <div>
            <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center">
                ...
                <div className="flex mb-6">
                    <input max={250} name="watts" type="text " placeholder={pHolder} className="w-24 h-10 flex-1 px-3 py-2 border-l-2 border-y-2 border-sky-950" />
                ...
                <button type="submit" value={submitValue}>Verificar Potência</button>
            </form>
