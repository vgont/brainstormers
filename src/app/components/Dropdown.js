...
export default function Dropdown() {
    ...
    return (
        <div className="relative flex flex-col items-center w-[340px] h-[340px] rounded-lg">
            ...
            {isOpen && (
                <div className="bg-blue-400 absolute top-20 flex flex-col items-start round-lg p-2 w-full" id="combobox">
                    {ageList.map((item)=> (
                        <div key={item.age} className="flex w-full justify-center hover:bg-blue-300 cursor-pointer rounded-r-lg border-l-transparent hover:border-l-white border-l-4">
